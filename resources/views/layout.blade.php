				...
				<div class="row">
					<div class="col-lg-8 col-12">
						...
						<div class="top-contact">
							<div class="single-contact"><i class="fa fa-phone"></i>Teléfono: +(52) 33-1315-6353</div> 
							<div class="single-contact"><i class="fa fa-envelope-open"></i>Email: contacto@tuweb.com</div>	
							<div class="single-contact"><i class="fa fa-clock-o"></i>Horario de atención: 08:00 AM - 6:00 PM</div> 
						</div>
						<!-- End Top Contact -->
					</div>	
					<div class="col-lg-4 col-12">
						<div class="topbar-right">
							...
							<ul class="social-icons">
								...
								<li><a href="https://www.nubeclick.com"><i class="fa fa-dribbble"></i></a></li>
							</ul>															
							<div class="button">
...
<!-- Footer -->
<footer class="footer" style="background-image:url('map.png')">
			<!-- Footer Top -->
							...
							<div class="single-widget footer-about widget">	
								...
								<div class="social">
									...
									<ul class="social-icons">
										...
										<li><a class="pinterest" href="https://www.pinterest.com" target="_blank"><i class="fa fa-pinterest-p"></i></a></li>
					...
					<div class="row">
						<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
							...
							<div class="footer-newsletter">
								<form action="/" method="get" class="newsletter-area">
					...
					<div class="row">
						<div class="col-12">
							<div class="copyright-content">
								<!-- Copyright Text -->
								<p>© Copyright <a href="https://www.nubeclick.com">Nubeclick</a>. Design &amp; Development By <a target="_blank" href="https://www.ruvalcaba.dev">Salvador Ruvalcaba</a></p>
							</div>
						</div>
					</div>
				</div>
